 ...
 * Rotalos los elementos de ese array, es decir, el elemento de la posición 0 debe pasar a la posición 1,
...
public class T7Ej6 {
    ...
    System.out.println("Array original:"); for (i = 0; i < 15; i++) {
            System.out.printf("|%3d ", i);
          }
    System.out.println("|"); for (i = 0; i < 75; i++) {
            System.out.print("￿");
          }
    System.out.println("￿"); for (i = 0; i < 15; i++) {
    ...
    System.out.println("\nArray rotado a la derecha una posición:"); for (i = 0; i < 15; i++) {
      System.out.printf("|%3d ", i);
    }
    System.out.println("|"); for (i = 0; i < 75; i++) {
      System.out.print("￿");
