...
public class T7Ej4 {
    ...
    int[] numero = new int[20]; int[] cuadrado = new int[20]; int[] cubo = new int[20]; // para declarar varios arrays en una misma línea, poner ; y no ,  //
    int i;
    for (i = 0; i < 20; i++) {
    numero[i] = (int)(Math.random()*101); cuadrado[i] = numero[i] * numero[i]; cubo[i] = cuadrado[i] * numero[i];
          }
