...
public class T7Ej3 {
    ...
    int[] n = new int[10]; int i; // hay que usar ; si declaramos en una misma linea array
    //  y numeros enteros por ejemplo. No vale con usar ,
        System.out.println("Por favor, introduzca 10 números enteros.");
        System.out.println("Pulse la tecla INTRO después de introducir cada número.");
    for (i = 0; i < 10; i++) {
    n[i] = Integer.parseInt(System.console().readLine());
    }
    System.out.println("\nLos números introducidos, al revés, son los siguientes:"); for (i = 9; i >= 0; i--) {
